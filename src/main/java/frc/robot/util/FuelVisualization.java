...
public class FuelVisualization {
   private final Translation3d redHubLocation = new Translation3d(RED_HUB_TRIANGULATED_X, HUB_TRIANGULATED_Y, HUB_TRIANGULATED_Z);
   private final Translation3d blueHubLocation = new Translation3d(BLUE_HUB_TRIANGULATED_X, HUB_TRIANGULATED_Y, HUB_TRIANGULATED_Z);
   // transformation
