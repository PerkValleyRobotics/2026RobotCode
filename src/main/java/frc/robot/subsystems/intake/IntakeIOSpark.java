...
public class IntakeIOSpark implements IntakeIO {
    ...
    public void updateInputs(IntakeIOInputs inputs) {
        ...
        ifOk(
                ...
                (value) -> inputs.intakeMotorSpeedRPM = value);
        ...
        ifOk(
                ...
                (value) -> inputs.turnIntakeSetpoint = value);

        ifOk(leftTurnMotor, turnAbsoluteEncoder::getPosition, (value) -> inputs.turnIntakeAbsoluteRotations = value);
