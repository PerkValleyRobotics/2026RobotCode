...
public class IntakeIOSpark implements IntakeIO {
  ...
  public IntakeIOSpark() {
    ...
    turnAbsoluteEncoder = leftTurnMotor.getAbsoluteEncoder();
  ...
  public void updateInputs(IntakeIOInputs inputs) {
    ...
    ifOk(intakeRunMotor, runEncoder::getVelocity, (value) -> inputs.intakeMotorSpeedRPM = value);
    ...
    ifOk(leftTurnMotor, leftTurnEncoder::getPosition, (value) -> inputs.turnIntakeSetpoint = value);

    ifOk(
        leftTurnMotor,
        turnAbsoluteEncoder::getPosition,
        (value) -> inputs.turnIntakeAbsoluteRotations = value);
